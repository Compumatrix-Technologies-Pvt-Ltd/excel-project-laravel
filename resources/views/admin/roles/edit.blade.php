        ...
        <div class="col-lg-12">
           ...
           <div class="card card-custom">
              <div class="card-header">
                 <h3 class="card-title">@lang('admin.TITLE_EDIT_ROLE')</h3>
              </div>
              <!--begin::Form-->
              <form class="form" action="{{ route('admin.roles.update', [base64_encode(base64_encode($rolesCollection->id))]) }}" data-toggle="validator" role="form" method="POST" id="updateForm">
                @csrf
                @method('PUT')
                 <div class="card-body">
                    <div class="form-group row">
                       <div class="col-lg-6">
                                ...
                                <input class="form-control" type="text" name="name" id="name" required data-error="@lang('admin.ERR_ROLE_NAME')" pattern="^[A-Za-z0-9 ]*$" data-pattern-error="@lang('admin.ERR_ALPHABETS_ONLY')" value="{{$rolesCollection->name}}" autocomplete="off">
