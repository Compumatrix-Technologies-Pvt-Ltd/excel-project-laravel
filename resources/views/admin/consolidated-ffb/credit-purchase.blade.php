        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex justify-content-between">
                    <h4 class="card-title mb-0 flex-grow-1">Credit Purchase Analysis by Supplier in M/Ton for <span class="yearDoc">[ {{date('Y')}} ]</span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="container-fluid mt-4">
                        <div class="table-responsive">
                            <table id="consolidatedCreditPurchaseAnalysisTable" class="table nowrap dt-responsive align-middle" style="width:100%">
...
@section('scripts')
    ...
    <script>
        $('#downloadPDF').on('click', function () {
            ...
            let url = `${ADMINURL}/purchase-analysis/consolidated/pdf?branch_id=${branchId}&year=${year}&purchaseType=credit`;
