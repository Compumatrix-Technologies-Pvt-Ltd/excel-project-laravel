...
<!-- Mirrored from themesbrand.com/velzon/html/saas/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Aug 2025 13:51:13 GMT -->
<head>
    <meta charset="utf-8" />
...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="{{route('admin.login')}}" class="btn btn-link fw-medium text-decoration-none text-body">Sign
                            in</a>
    ...
    <!-- landing init -->
    <script src="{{ asset('/assets/admin/js/pages/landing.init.js')}}"></script>
</body>


<!-- Mirrored from themesbrand.com/velzon/html/saas/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Aug 2025 13:51:17 GMT -->
</html>