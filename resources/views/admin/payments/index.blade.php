            ...
            <div class="card">
                <div class="card-header align-items-center d-flex justify-content-between">
                    ...
                    <div class="card-toolbar">
                        ...
                        <button type="button" class="btn btn-primary btn-label waves-effect waves-ligh"
                ...
                <div class="card-body">
                    <div class="col-md-3">
                        ...
                        <select name="status" id="paymentMethod" class="form-select">
                    ...
                    <div class="container-fluid mt-4">
                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row gy-4">
                                            <form action="{{route('admin.payments.pdf')}}" method="POST" class="row g-3">
                                                @csrf
                                                <div class="col-md-12">
                        ...
                        <div id="previewModal" class="modal fade" tabindex="-1" aria-labelledby="bankEditModalLabel"
                            aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <div class="row gy-4">
                                            <form action="{{route('admin.payments.pdf.preview')}}" method="GET" class="row g-3">
                                                @csrf
                                                <div class="col-md-12">
                                                    <label for="bankIdInput" class="form-label">Payment Method<span
                                                            class="text-danger">*</span></label>
