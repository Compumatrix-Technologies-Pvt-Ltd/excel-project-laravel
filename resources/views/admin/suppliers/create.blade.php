            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.suppliers.create') }}">Create Supplier</a>
                        </li>
                    </ol>
                </div>
                            ...
                            <form action="javascript:void(0);" class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="supplierCodeInput"
                                            aria-label="Supplier Code" aria-describedby="prefixInput">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="supplierAddress1" class="form-label">Address 1<span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="supplierAddress1" rows="3"></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label for="supplierAddress2" class="form-label">Address 2</label>
                                    <textarea class="form-control" id="supplierAddress2" rows="3"></textarea>
                                </div>

                                <div class="col-md-6">
                                    <label for="inputMPOB" class="form-label">MPOB License No</label>
                                    <input type="text" class="form-control" id="inputMPOB">
                                </div>

                                <div class="col-md-6">
                                    <label for="MPOBExpiryDate" class="form-label">MPOB Expiry Date</label>
                                    <input type="date" class="form-control" id="MPOBExpiryDate">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputMSOPCertficate" class="form-label">MSPO Cert. No</label>
                                    <input type="text" class="form-control" id="inputMSOPCertficate">
                                </div>
                                <div class="col-md-6">
                                    <label for="MSPOExpiryDate" class="form-label">MSPO Expiry Date</label>
                                    <input type="date" class="form-control" id="MSPOExpiryDate">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputSupsidy">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="inputRemark" rows="3"></textarea>
