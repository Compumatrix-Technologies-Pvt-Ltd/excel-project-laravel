                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    ...
                                    <div class="mt-4">
                                        <form id="AddForm" action="{{ route('verify.email') }}" id="kt_sign_in_form"
                                            ...
                                            <div class="mb-3 form-group">
                                                <label for="username" class="form-label">Mobile Number <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="mobile" name="mobile_number"
                                                    placeholder="Enter Mobile Number"
                                                    data-error="Please enter mobile number." pattern='^[0-9]{10}$'
                                                    data-pattern-error="Mobile number format is invalid."
                                                    autocomplete="off">
                                            ...
                                            <div class="mb-3 form-group">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    ...
                                                    <span class="help-block with-errors err_password"
                                                        style="color:red;">
                                                </div>
                                            </div>
                                            <div class="mb-3 form-group">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <button class="btn btn-success w-100" type="submit">Send Verification
                                                    Email</button>
