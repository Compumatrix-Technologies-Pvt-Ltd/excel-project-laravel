                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="p-2">
                                            <form action="{{ route('forgot.password.reset',$token) }}" id="kt_new_password_form" novalidate="novalidate" class="form" >
                                            {{ csrf_field() }}
                                                   <div class="mb-3 form-group">
                                                    <label class="form-label" for="password-input">Password</label>
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" name="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" autocomplete="off"  data-error="Please enter new password." required>
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password" name="confirm_password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Confirm password" id="confirm-password-input" required data-error="Please enter confirm password." data-match="#password-input" data-match-error="Whoops, these don't match">
                                                        ...
                                                        <span class="help-block with-errors err_confirm_password" style="color:red;">
...
<script src="{{asset('/assets/admin/js/auth/password-reset.js') }}"></script>
@endsection
