                        ...
                        <div class="row justify-content-center g-0">
                                    ...
                                    <div class="position-relative h-100 d-flex flex-column">
                                        <div class="mb-4">
                                            <a href="index-2.html" class="d-block">
                                                <img src="{{ asset('/assets/admin/images/new-logo.png') }}"
                                                    alt="logo" height="100">
                                            </a>
                                        </div>
                                        <div class="mt-auto">
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    ...
                                    <p class="text-muted">Reset password with {{ config('constants.FOOTER_COPYRIGHT') }}</p>
                                    ...
                                    <div class="p-2">
                                        <form action="{{ route('admin.auth.password.submit') }}" novalidate="novalidate"
