                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            <h3 class="display-6 fw-medium mb-4 lh-base text-white">Streamline FFB Purchases, Invoicing, and Supplier Payments</h3>
            ...
            <div class="container">
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 col-sm-7 mx-auto">
                        <div>
                            <img src="{{ asset('/assets/admin/images/invoice-billing-information-form-graphic-concept.jpg') }}" alt="" class="img-fluid mx-auto">
                        </div>
                    </div>
                    <div class="col-lg-6">
                             ...
                             <div class="row text-center gy-4">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div>
                                        ...
                                        <p class="text-muted">Satisfied Clients</div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-14">Ticket No., date, supplier, weight (MT), branch—import or enter manually.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-14">Subscription plans with user/branch limits, monthly/annual billing, trial options.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-lg-4">
                        <div class="card plan-box mb-0 ribbon-box right">
                            <div class="card-body p-4 m-2">
                                ...
                                <div class="py-4 text-center">
                                    <h1 class="month"><sup><small>RM</small></sup><span class="ff-secondary fw-bold">29</span> <span class="fs-13 text-muted">/Month</span></h1>
                                    <h1 class="annual"><sup><small>RM</small></sup><span class="ff-secondary fw-bold">261</span> <span class="fs-13 text-muted">/Year</span></h1>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div>
                            <div class="mt-4">
                                ...
                                <div class="ff-secondary fw-semibold">Lot 80-2F, Block 6, Prima Square Sandakan; Sabah; Postal Code: 90000</div>
                            </div>
                            <div class="mt-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="comments" id="comments" rows="3" class="form-control" placeholder="Your message..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
