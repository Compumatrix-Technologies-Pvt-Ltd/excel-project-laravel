                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme03">
                                <img src="{{asset('/assets/admin/images/demo/corporate.png')}}" alt=""
                                    class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme09">
                                <img src="{{asset('/assets/admin/images/demo/interactive.png')}}" alt=""
                                    class="img-fluid">
                            </label>
                        </div>
...
<!-- JAVASCRIPT -->
<script src="{{asset('/assets/admin/plugins/custom/jquery-3.6.0.min.js') }}"></script>
<script src="{{ asset('/assets/admin/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('/assets/admin/libs/simplebar/simplebar.min.js') }}"></script>
<script src="{{asset('/assets/admin/plugins/custom/axios/axios.min.js') }}"></script>
<script src="{{ asset('/assets/admin/libs/sweetalert2/sweetalert2.min.js') }}"></script>
<script src="{{asset('/assets/admin/plugins/custom/validator/validator.min.js') }}"></script>
<script src="{{asset('/assets/admin/plugins/custom/lodingoverlay/loadingoverlay.min.js') }}"></script>
