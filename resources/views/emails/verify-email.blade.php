<div class="row">
    ...
    <div class="col-12">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                @if ($type == 'email_verification')
                                                    <h3 style="margin-bottom: 13px;">Hello, {{ $data['user']->name }}!</h3>
                                                    <p style="margin-bottom: 13px;">Your one-time OTP is:
                                                        <strong>{{ $data['otp'] }}</strong>
                                                    </p>
                                                @else
                                                    <h3 style="margin-bottom: 13px;">Hello, {{ $data['user']->name }}!</h3>
                                                    <p style="margin-bottom: 13px;">Your login password is:
                                                        <strong>{{ $data['plain_password'] }}</strong>
                                                </p> 
                                                @endif

                                                <p style="margin-bottom: 0;">Please validate your email address in order
                                                    to complete your registration.</p>
                                                <p style="margin-bottom: 0;">If you did not request this, please ignore
                                                    this email.</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block" itemprop="handler" itemscope
                                                ...
                                                valign="top">
                                                <a href="{{ route('verify.email', ['id' => base64_encode(base64_encode($user->id))]) }}"
                                                    itemprop="url"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <a href="{{ route('verify.email', ['id' => base64_encode(base64_encode($user->id))]) }}"
                                                    target="_blank">http://localhost/excel-project-laravel/email-verification</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <div style="text-align: center; margin: 25px auto 0px auto;font-family: 'Roboto', sans-serif;">
            <h4 style="font-weight: 500; line-height: 1.5;font-family: 'Roboto', sans-serif;">Need
                Help
                ?</h4>
            <p style="color: #878a99; line-height: 1.5;">Please send and feedback or bug info to <a href="#"
                    style="font-weight: 500;">info@velzon.com</a></p>
